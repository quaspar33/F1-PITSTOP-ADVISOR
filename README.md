...
*py -3.12 -m venv .venv; .venv/Scripts/activate; pip install poetry>=2.2.1; poetry install --no-root*

### Mac
If you're using Mac, use:  
*python -3.12 -m venv .venv; source .venv/bin/activate; pip install poetry>=2.2.1; poetry install --no-root*
